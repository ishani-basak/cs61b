...
public class Tester {
    ...
    public static void isEvenTest() {
        ...
        assertTrue(Solutions.isEven(0), "IsEvenTest");
    }
    ...
    public static void maxTest() {
       ...
       assertIntEquals(20, Solutions.max(new int[] { 17, -16, 4, -5, 20 }), "maxTest");
    }
    ...
    public static void wordBankTest() {
        ...
        assertTrue(Solutions.wordBank("cool", adjectives), "wordBankTest");
    }
    ...
    public static void threeSumTest() {
        ...
        assertFalse(Solutions.threeSum(new int[] {-6, 2, 5}), "3SUM Test");
    }
